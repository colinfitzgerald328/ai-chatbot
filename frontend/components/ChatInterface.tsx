...
import { SunIcon, MoonIcon, DeleteIcon, SettingsIcon } from "@chakra-ui/icons";
...
const ChatInterface: React.FC = () => {
  ...
  const scrollToMaintainPosition = useCallback(() => {
    if (!chatContainerRef.current || !isStreaming || !shouldScrollRef.current)
      return;
          ...
          {messages.length === 0 ? (
            ...
            >
              ...
              <Text color="gray.500" fontSize="sm" textAlign="center" maxW="md">
                Ask health questions, get information about medical conditions,
                or learn about wellness topics
              </Text>
            </Flex>
          ) : (
          ...
          <InputGroup size="md">
            ...
            <InputRightElement width="4.5rem" h="full">
              {input.trim() ? (
                ...
                <Kbd color="gray.500" opacity={0.6} fontSize="xs">
                  Enter
                </Kbd>
              )}
            </InputRightElement>
